...
// UpdateUser 通过id更新数据
func (s *Service) UpdateUser(reqUser *dto.ReqUser) (id primitive.ObjectID, err error) {
...
// DeleteUser 通过id删除用户
func (s *Service) DeleteUser(id string) (objectId primitive.ObjectID, err error) {
	lg := utils.GetDefaultLogger()
	//1.删之前先查询是否有该条数据
